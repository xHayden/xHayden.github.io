          ...
          {design == 0 ? (
            <div className="flex flex-col gap-2">
              ...
              <p className="">
                ...
                design to give your basic info with no cool frontend tricks, simplifying everything.
              </p>
              <p>So simply,</p>
              <div className="flex flex-col gap-6">
                <div className="">
                  <ul className="list-disc-fix">
                    ...
                    <li>
                      I'm a Computer Science Major with a Psychology Minor.
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="list-disc-fix gap-1 flex flex-col">
                    <li>
                      ...
                      <ul className="list-disc-fix">
                        <li>
                          I worked on the Southface project team to create and
                          deploy a building planner for{" "}
                          <a href="https://earthcraft.org/" target="_blank">
                            Earthcraft
                          </a>
                          , a sustainable housing program. Southface has
                          estimated the app should improve the use of
                          Earthcraft's resources by up to 50%.
                        </li>
                        <li>
                          I then worked on{" "}
                          <a
                          ...
                          , Bits of Good's infrastructure API built in Nest.js
                          to accelerate scalable development workflows
                          internally.{" "}
                        </li>
                        <li>
                          Now, I'm working on a game gallery for{" "}
                          <a
                          ...
                          , a non-profit preventing teen dating violence.
                        </li>
                      </ul>
                    </li>
                    <li className="">
                      <span className="font-semibold">MaxRewards</span> -
                      Software Development Intern (August 2023 - February 2024)
                      <ul className="list-disc-fix">
                        <li>
                          Developed{" "}
                ...
                <div>
                  ...
                  <ul className="list-disc-fix">
                    ...
                    <li>
                      ...
                      <ul className="list-disc-fix">
                        <li>
                          ...
                          data to charge you money if you skip too many
                          workouts.
                        </li>
                      </ul>
                    </li>
                    ...
                    <li>
                      ...
                      <ul className="list-disc-fix">
                        <li>
                          An all-in-one live-updating data collection and
                          analysis tool for FRC Robotics teams built by Team
                          4026.
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul className="list-disc-fix">
                        <li>
                          A developer toolkit similar to Firebase for Bits Of
                          Good infrastructure.
                        </li>
                      </ul>
                    </li>
                ...
                <div>
                  ...
                  <ul className="list-disc-fix">
                    ...
                    <li>
                    <a href="https://notes.hayden.gg">
                        Notes
                      </a>
                    </li>
                    <li>
                    <a href="https://img.hayden.gg">
                        Image Hosting
                      </a>
                    </li>
                  </ul>
